...
public class TC_1_Verify_Medica_InformationUS extends Bharathi{
	...
	public void launchURL() {
		...
		beforeNavigateTo("https://www.jazzpharma.com/", driver);

		driver.get("https://www.jazzpharma.com/");
		
		afterNavigateTo("https://www.jazzpharma.com/", driver);
...
//	@Test(priority = 4)
//	public void clickMedicalInformationUsTab() {
//		
//		JavascriptExecutor js = (JavascriptExecutor)driver;
//		
//		WebElement medicalInformationUs= driver.findElement(By.xpath("//a[text()='Medical Information US']"));
//		
//		js.executeScript("arguments[0].scrollIntoView()", medicalInformationUs);
//
//		medicalInformationUs.click();
//		
//		System.out.println("in @test ClickMedicalInformationUsTab method");
//	}
