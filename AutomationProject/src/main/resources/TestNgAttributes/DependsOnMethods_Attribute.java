...
public class DependsOnMethods_Attribute {
	...
	@Test(dependsOnMethods = "verifyMedicinesTab")
	...
	@Test(dependsOnMethods = "clickMedicinesTab")
	...
	@Test(dependsOnMethods = "verifyMedicalInformationUs")
	public void verifyMedicinesHeaderText() {
		
		String expectedText = "Purabhi";
